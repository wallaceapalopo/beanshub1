...
export default function LoginForm() {
  ...
  const mockUsers = [
    { id: '1', email: 'admin@beanshub.com', password: 'admin123', name: 'Admin BeansHub', role: 'Admin' as const },
    { id: '2', email: 'roaster@beanshub.com', password: 'roaster123', name: 'Master Roaster', role: 'Roaster' as const },
    { id: '3', email: 'staff@beanshub.com', password: 'staff123', name: 'Staff Penjualan', role: 'Staff' as const }
  ];
      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8">
          <div className="text-center mb-6 sm:mb-8">
            ...
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-2">BeansHub</h1>
            <p className="text-gray-600 text-sm sm:text-base">Sistem Manajemen Roastery Coffee House</p>
          </div>
